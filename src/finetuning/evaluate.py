...
def generate_all(model_id: str, adapter: Optional[str], samples: List[dict],
    ...
    if adapter:
        ...
        # Sem merge_and_unload(): em 4-bit a fusao pode anular o adaptador
...
# NOTA TECNICA
# --------------------------------------------------------------------
# merge_and_unload() em modelo quantizado em 4-bit pode anular o efeito
# do adaptador: os deltas do LoRA sao pequenos e se perdem no
# arredondamento da quantizacao (ver UserWarning do peft). Para avaliacao,
# mantemos o PeftModel sem fusao.
