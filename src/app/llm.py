...
def load_pipeline(model_name: str = BASE_LLM, adapter: Optional[str] = None):
    ...
    tokenizer.padding_side = "left"   # geracao: enchimento a esquerda
    ...
    if adapter:
        ...
        # SEM merge_and_unload(): em 4-bit a fusao anula os deltas do LoRA
        # por arredondamento. Foi o que invalidou a primeira avaliacao.
